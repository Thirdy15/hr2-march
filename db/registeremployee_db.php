...
function generateEmployeeId($conn) {
    do {
        ...
        $checkIdQuery = "SELECT * FROM employee_register WHERE employee_id = ?";
...
$insertQuery = "INSERT INTO employee_register (employee_id, first_name, last_name, email, password, role, gender, department, position, face_descriptor, face_image) 
                VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
