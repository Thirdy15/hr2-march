...
?>
    ...
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark border-bottom border-1 border-secondary">
        <a class="navbar-brand d-none d-md-inline-block form-inline ps-3 text-light" href="../../employee/fieldworker/dashboard.php">Employee Portal</a>
    ...
    <script>
        ...
        const features = [
            ...
            { name: "Leave Request", link: "../../employee/fieldworker/leave_request.php", path: "Leave Management/Leave Request" },
            ...
            { name: "View Your Rating", link: "../../employee/fieldworker/social_recognition.php", path: "Social Recognition/View Your Rating" },
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            notificationList.addEventListener('click', function (event) {
                ...
                if (notificationItem && notificationItem.classList.contains('unread-notification')) {
                    ...
                    fetch('../../employee_db/fieldworker/markNotif.php', {
                        method: 'POST',
                        headers: {
            ...
            notificationList.addEventListener('click', function (event) {
                if (event.target.closest('.delete-notification')) {
                    ...
                    fetch('../../employee_db/fieldworker/deleteNotif.php', {
                        method: 'POST',
                        headers: {
                            'Content-Type': 'application/json'
                        },
