                    ...
                    <div class="nav">
                        ...
                        <ul class="navbar-nav ms-auto ms-md-0 me-3 me-lg-4">
                            <li class="nav-item dropdown text">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                                    ...
                                    <li><a class="dropdown-item" href="../../employee/contractual/settings.php">Settings</a></li>
                                    <li><a class="dropdown-item" href="../../employee/contractual/activityLog.php">Activity Log</a></li>
                        ...
                        <div class="collapse" id="collapseTAD" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                <a class="nav-link text-light loading " href="../../employee/contractual/scheduling.php">Scheduling</a>
                                <a class="nav-link text-light loading " href="../../employee/contractual/timesheet.php">Timesheet</a>
                            </nav>
                        </div>
                        ...
                        <div class="collapse" id="collapsePM" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                            <nav class="sb-sidenav-menu-nested nav">
                                ...
                                <a class="nav-link text-light loading" href="../../employee/contractual/department.php">Evaluation Department</a>
                            </nav>
                        </div>
